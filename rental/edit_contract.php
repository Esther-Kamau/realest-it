     ...
     <div id="content-wrapper" class="d-flex flex-column">
       ...
       <div id="content">
         ...
         <div class="container-fluid">
           ...
           <p style="color:green;"><b><b>Please choose a contract to change from the table showing contract information.</b></b></p>
                   ...
                   <tbody>
                     <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                       <tr>
                         ...
                         <td><input type='text' class='form-control form-control-user' name='id' value = "<?php echo  @$_GET['id']; ?>"></td>
                       </tr>
