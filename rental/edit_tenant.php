     ...
     <div id="content-wrapper" class="d-flex flex-column">
       ...
       <div id="content">
         ...
         <div class="container-fluid">
           ...
           <p style="color:Green;"><b><b>Please choose a tenant to change his or her info from the table showing tenant information.</b></b></p>
                   ...
                   <tbody>
                     <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                       <tr>
                         ...
                         <td><input type='text' class='form-control form-control-lg' name='id' value = "<?php echo  @$_GET['id']; ?>" readonly></td>
                       </tr>
